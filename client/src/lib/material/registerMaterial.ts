/**
 * Registrazione side-effect dei web component Material (material-esm/material).
 * Aggiungi qui import per ogni `md-*` usato nell'app.
 *
 * Doc ufficiale fork: https://github.com/material-esm/material
 * Linee guida MD3 (stesso modello API): https://material-web.dev/
 */
